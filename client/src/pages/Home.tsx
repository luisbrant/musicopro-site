...
export default function Home() {
  ...
  const { trackBuyClick, trackFreeClick } = useAnalytics();

  // Simple A/B test randomly assigned on mount
  useState(() => {
  ...
  const faqs = [
    ...
    { question: "Posso cancelar?", answer: "Sim. Cancelamento simples a qualquer momento." }
  ];
      ...
      <main className="pb-16">
        ...
        <section className="bg-white pt-24 pb-20 px-4 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 text-lg font-bold text-red-700/80 mb-8 pt-4">
              ...
              <span className="hidden md:inline">•</span>
              <span>Pague o imposto justo.</span>
            </div>

            <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
              <button
                onClick={() => { trackFreeClick(); window.location.href = '/app'; }}
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 relative">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center text-center relative z-10 transition hover:-translate-y-1 hover:shadow-md">
                ...
                <p className="opacity-80 text-sm">O sistema calcula o limite de isenção e mostra o Carnê-Leão abater usando despesas dedutíveis.</p>
              </div>
        ...
        <section className="py-20 px-4 max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { text: "Eu perdia horas na planilha tentando não errar o Carnê-Leão. Com o app eu sei exatamente o imposto a pagar no mês.", author: "Felipe T.", role: "Baterista Autônomo" },
              { text: "Parei de pagar imposto pelo bruto e comecei a deduzir minhas despesas reais. Se pagou no primeiro mês, recomendo demais.", author: "Mariana S.", role: "Professora de Canto" },
              { text: "Os recibos e orçamentos em PDF mudaram a forma como meus contratantes me enxergam. Muito mais profissional.", author: "Rodrigo M.", role: "Produtor Musical" }
            ].map((dep, idx) => (
        ...
        <section className="py-24 px-4 bg-white relative border-t border-[#E8E3DC]">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg opacity-80">Compare e escolha a melhor ferramenta para o controle da sua carreira.</p>
            </div>
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="font-semibold text-[15px]">
                  <tr className="border-b border-gray-100">
                    ...
                    <td className="p-6 text-center text-gray-500">Ilimitado</td>
                    <td className="p-6 text-center bg-[#f8fafe]">Ilimitado</td>
                  </tr>
                  <tr className="border-b border-gray-100">
                    <td className="p-6 opacity-90">Previsão de Imposto</td>
                    <td className="p-6 text-center text-gray-500">Sim (Visão básica)</td>
                    <td className="p-6 text-center bg-[#f8fafe]">Carnê-Leão completo</td>
                  </tr>
                  <tr className="border-b border-gray-100">
                    <td className="p-6 opacity-90 flex flex-col">Gerador de PDF <span className="text-xs font-normal opacity-70">Recibos, propostas, relatórios</span></td>
                    <td className="p-6 text-center text-gray-500"><Minus className="mx-auto" size={20} /></td>
                    <td className="p-6 text-center bg-[#f8fafe] text-[#d4af37]"><CheckCircle className="mx-auto" size={22} /></td>
                  </tr>
                  <tr className="border-b border-gray-100">
                    <td className="p-6 opacity-90 flex flex-col">Contratos e Orçamentos <span className="text-xs font-normal opacity-70">Modelos prontos para envio</span></td>
                    <td className="p-6 text-center text-gray-500"><Minus className="mx-auto" size={20} /></td>
                    <td className="p-6 text-center bg-[#f8fafe] text-[#d4af37]"><CheckCircle className="mx-auto" size={22} /></td>
                  </tr>
                  <tr>
                    <td className="p-6 opacity-90 flex flex-col">Guia Fiscal / Treinamento <span className="text-xs font-normal opacity-70">Acesso à Academy</span></td>
                    <td className="p-6 text-center text-gray-500"><Minus className="mx-auto" size={20} /></td>
                    <td className="p-6 text-center bg-[#f8fafe] text-[#d4af37]"><CheckCircle className="mx-auto" size={22} /></td>
                  </tr>
                </tbody>
            ...
            <div className="mt-12 text-center flex justify-center">
              <button
                onClick={() => { trackBuyClick(); scrollToPlan(); }}
          ...
          <div className="max-w-3xl mx-auto flex flex-col items-center text-center">
            ...
            <div className="bg-white p-8 md:p-14 rounded-[2.5rem] shadow-2xl w-full relative">
              ...
              <button
                ...
                className="w-full bg-[#d4af37] hover:bg-[#c99a2e] text-[#0c2461] font-black py-6 rounded-2xl shadow-[0_10px_30px_rgba(212,175,55,0.4)] transition-all text-2xl md:text-3xl transform hover:scale-[1.02] active:scale-95 mb-4"
              >
                Quero assinar o PRO
              </button>
              ...
              <div className="text-center space-y-2 mt-6">
                ...
                <p className="text-sm font-medium opacity-80 text-gray-600">
                  Teste o plano PRO na prática. Sem multas e sem asteriscos: se não gostar, cancele com 1 clique e devolvemos 100% via Hotmart.
                </p>
              </div>
            </div>
