      ...
      <section className="bg-[#0c2461] text-white py-16 md:py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            ...
            <a href="https://app.musicopro.app.br/app.html" target="_blank" rel="noopener noreferrer" className="bg-white/10 backdrop-blur-sm text-white border border-white/30 px-8 py-4 rounded-lg text-lg font-bold hover:bg-white/20 transition flex items-center justify-center gap-2">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="max-w-md mx-auto bg-white rounded-2xl shadow-xl overflow-hidden border border-[#E8E3DC] relative">
            ...
            <div className="p-8">
              ...
              <a 
                href="https://app.musicopro.app.br/app.html"
                target="_blank"
                rel="noopener noreferrer" 
                download
